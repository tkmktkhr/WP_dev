...
function ultimate_scripts_styles_method() {
	...
	wp_enqueue_style('ultimate-font-awesome', get_template_directory_uri().'/font-awesome/css/font-awesome.css');
	// Load the html5 shiv.
	 ...
	 */
	wp_register_script('jquery_cycle', ULTIMATE_JS_URL.'/jquery.cycle.all.js', array('jquery'), '3.0.3', true);
